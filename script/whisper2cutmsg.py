...
_detectors_eiji_begin = [
	...
	DetectorRegex(r'.*(祝福して?|心から期待して?)お祈り(|いた)します', ((0, -0.9), (+1, 0.2), (+2, 0.3), (+3, 0.4))),
...
_detectors_eiji_end = [
	...
	# beginning of prayer
	DetectorRegex(r'.*(愛する|恵み深い|めぐみ深い) ?天の(|父なる)(お父様|神様)', ((-3, -0.5), (-2, +0.5), (0, +1))),
